...
const MobileNav = () => {
  ...
  return (
    <>
      <div className="fixed left-0 right-0 top-0 z-50 flex items-center justify-between bg-primary bg-opacity-50 p-4">
      ...
      {isOpen && (
        <div className="fixed bottom-0 left-0 right-0 top-16 z-40 bg-primary bg-opacity-50 p-4">
          {menuList.map((group) => (
