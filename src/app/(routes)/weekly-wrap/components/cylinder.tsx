  ...
  return (
    <div className={cn("absolute", className)}>
      <div className="relative">
        <div
          className={cn(
            "absolute left-0 top-0 z-20 aspect-square w-52 origin-top-right rounded-full bg-accent-200 [transform:rotateX(60deg)]",
          )}
        />
        <div className="absolute z-50 h-52 w-52 -translate-y-[60%] rounded-full bg-[linear-gradient(180deg,white_25%,#6a34b2_150%)] shadow-[inset_0px_-16px_20px_#0050A3]" />
        <div
          className={cn(
            "absolute left-0 top-12 h-[65vh] w-52",
